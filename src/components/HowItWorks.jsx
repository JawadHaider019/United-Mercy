          ...
          <div className="w-full relative h-auto">
            <svg viewBox="60 0 690 550" className="w-full h-auto overflow-visible">
              ...
              <foreignObject x="480" y="5" width="265" height="95" className="overflow-visible">
                <div xmlns="http://www.w3.org/1999/xhtml" style={{ width: '100%', height: '100%' }} className="p-3 rounded-2xl border-2 border-[#22C55E] bg-[#151E32]/95 shadow-xl">
              ...
              <foreignObject x="480" y="113" width="265" height="95" className="overflow-visible">
                <div xmlns="http://www.w3.org/1999/xhtml" style={{ width: '100%', height: '100%' }} className="p-3 rounded-2xl border-2 border-[#A855F7] bg-[#151E32]/95 shadow-xl">
                  <div className="flex items-center justify-between">
              ...
              <foreignObject x="480" y="221" width="265" height="95" className="overflow-visible">
                <div xmlns="http://www.w3.org/1999/xhtml" style={{ width: '100%', height: '100%' }} className="p-3 rounded-2xl border-2 border-[#EAB308] bg-[#151E32]/95 shadow-xl">
                  <div className="flex items-center justify-between">
              ...
              <foreignObject x="480" y="329" width="265" height="95" className="overflow-visible">
                <div xmlns="http://www.w3.org/1999/xhtml" style={{ width: '100%', height: '100%' }} className="p-3 rounded-2xl border-2 border-[#3B82F6] bg-[#151E32]/95 shadow-xl">
                  <div className="flex items-center justify-between">
              ...
              <foreignObject x="480" y="437" width="265" height="95" className="overflow-visible">
                <div xmlns="http://www.w3.org/1999/xhtml" style={{ width: '100%', height: '100%' }} className="p-3 rounded-2xl border-2 border-[#EF4444] bg-[#151E32]/95 shadow-xl">
                  <div className="flex items-center justify-between">
