              ...
              <div className="flex shrink-0 animate-[scroll_35s_linear_infinite] items-center gap-4 sm:gap-6">
                {PARTNERS_DATA.concat(PARTNERS_DATA, PARTNERS_DATA).map((partner, index) => (
                  <div
                    ...
                    className="flex items-center gap-3.5 px-4 py-3  shrink-0 min-w-[220px]"
                  >
                    {/* Icon on Left Side */}
                    <div className="w-15 h-15 rounded-3xl bg-sky-50/90 border border-sky-100 flex items-center justify-center shrink-0 group-hover:bg-[#0284C7] group-hover:border-[#0284C7] transition-all duration-300 shadow-inner">
                      <Award className="w-10 h-10 text-[#0284C7] group-hover:text-white transition-colors duration-300" />
                    </div>
